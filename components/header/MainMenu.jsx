  ...
  return (
    <nav className="menu js-navList">
      <ul className={`menu__nav ${style} -is-active`}>
        ...
        >
          <a href="#">
            <span className="mr-10 text-white">Dubai</span>
            <i className="icon icon-chevron-sm-down text-white" />
          </a>
          <ul className="subnav">
        ...
        <li className="menu-item-has-children -has-mega-menu">
          <a href="#">
            <span className="mr-10">Dubai</span>
...
{/* 
        ...
        >
          <a href="#">
            <span className="mr-10">workshop</span>
            <i className="icon icon-chevron-sm-down" />
          </a>
          <ul className="subnav">
        ...
        >
          <a href="#">
            <span className="mr-10">Parts</span>
            <i className="icon icon-chevron-sm-down" />
          </a>
          <ul className="subnav ">
