  ...
  return (
    <>
      ...
      <div className="sidebar__item pb-30">
        <h5 className="text-18 fw-500 mb-10">Monthly Price</h5>
        <div className="row x-gap-10 y-gap-30">
          <div className="col-12">
            <PirceSlider />
            <h5 className="text-18 fw-500 mt-10"> Year</h5>
            <YearSlider />
          </div>
        </div>
      </div>
      ...
      <div className="sidebar__item -no-border">
        <h5 className="text-18 fw-500 mb-10">Body Type</h5>
        {/* <SearchBox /> */}
      </div>
      {/* End search box */}
      ...
      <div className="sidebar__item">
        <h5 className="text-18 fw-500 mb-10"> City</h5>
        <div className="sidebar-checkbox">
          <PopularFilters />
        </div>
      ...
      <div className="sidebar__item">
        <h5 className="text-18 fw-500 mb-10">Features</h5>
        <div className="sidebar-checkbox">
          <AminitesFilter />
        </div>
